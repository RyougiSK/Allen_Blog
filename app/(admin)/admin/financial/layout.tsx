...
import { TrendingUp, LineChart, GitBranch, Activity, Droplets, PieChart } from "lucide-react";
...
const tabs = [
  ...
  { href: "/admin/financial/asset-classes", label: "Asset Classes", icon: PieChart, exact: true },
];
